# This is a second improvement on the original kernel by Pranav Pandya
# First improvement was done by Alexey Pronin
# link to orginal kernel is https://www.kaggle.com/pranav84/single-lightgbm-in-r-with-75-mln-rows-lb-0-9690
# link to first improved kernel is https://www.kaggle.com/graf10a/pranav-s-lgbm-lb-0-9698?scriptVersionId=3079197
# 
...
# 6. Changed scale_pos_weight to 200. It is giving maximum benefit between 99 to 400. 
# I chose to run on multiple values but 200 came out to be the best. Improved the LB score by 0.0001
# 
